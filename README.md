...
[Email](mailto:your_email@ucr.edu) | [Download Resume (PDF)](assets/resume.pdf)

---

## 🚀 Professional Profile
I am an Electrical Engineering student specializing in the intersection of **hardware-software co-design, embedded systems, and automated computer vision workflows**. As the incoming **IEEE Projects Chair** at UCR and an Electrical Engineer for **Highlander Racing (Formula SAE)**, I build physical hardware architectures and couple them with intelligent machine learning pipelines.

---

## 🛠️ Core Engineering Projects & Research

### 1. Embedded Systems & Hardware Engineering (Formula SAE)
**Role:** Electrical Engineering Intern | *Highlander Racing FSAE*
...
* Modeled complex mechanical multi-body structures and mass-spring-damper resonance states utilizing **MATLAB and Simulink**.
...
* **1st Place Winner** – YunTech Autonomous Robotics Championship
